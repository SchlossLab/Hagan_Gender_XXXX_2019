...
write_csv(gender_join, "Processed_Data/b_c_gender_data/B_C_auth_genderize_join.csv")
...
write_csv(country_gender_join, "Processed_Data/b_c_gender_data/B_C_auth_country_genderize_join.csv")
