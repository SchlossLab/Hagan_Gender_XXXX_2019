...
plot_grid(auth_type_A, auth_type_B, 
          labels = c('A', 'B'))
#A #cross ASM rejection rates (all genders)
#B #rejection rates by journ (m/w) -- need to highlight instances with diff > 5%
...
```{r, other_factors, include=FALSE, echo=FALSE, message=FALSE}
