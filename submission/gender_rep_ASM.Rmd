...
```{r, plot_ed_rej}
source("../code/editorial_rejections.R")
...
```
  ...
  + slight disparity in editorial rejection rates according to institution type (rej_by_inst_type.R)
      + greatest difference (4%) occurs for institute/medical schools (Supplementary)
      + trend holds for most journals and is >20% diff at JCM (R2s), mBio (Federal), MCB (low research), AEM (industry research) (supplementary)
...
source("../code/time_to_final_rejection.R")
