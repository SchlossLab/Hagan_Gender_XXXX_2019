...
The proportions of men (long dash) and women (solid) authors at ASM have decreased over time at equvalent rates, with a ratio of men to women authors of 4:3 since 2012. This decrease corresponds with an increase in the proportion of unclear (dotted) authors (Figure 3A). The proportion of papers submitted with men (blue dashed) and women (orange dashed) first authors have remained constant and equivalent at about 3X% percent (Figure 3B), as have their respective proportions of published manuscripts (solid lines). Conversely, the proportion of submitted papers with men corresponding authors has remained steady at X% and the proportion with women corresponding authors at X%. However, their respective proportions of published manuscripts are dissimilar (Figure 3C). The published manuscript proportion where men are corresponding authors seems to have a much larger gap relative to that of women corresponding authors, which suggests disproportionate success for men relative to women corresponding authors. These trends are similar across individual journals (SupplementaryX).

The dominant group of manuscripts submitted have men as corresponding authors but lack any women authors, and despite men corresponding authors submitting more papers than women corresponding authors, the number of papers with women corresponding authors and greater than half of the authors are women exceeds those with men corresponding authors (Figure 3D). Additionally, the proportion of women authors decreases as the number of authors increases (Figure 3E).

Further analyses will not include unclear authors, though their representation will be taken into account where appropriate. 
